...
<head>
	...
	<title>Maxclean - Gallery 02</title>
...
<body data-offset="200" data-spy="scroll" data-target=".ow-navigation">
	...
	<main>
		...
		<!-- Gallery Section -->
		<div class="gallery-section gallery-section-1 gallery-section-2 container-fluid no-padding">
			<!-- Container -->
			<div class="container">
				<!-- Section Header -->
				...
				<ul id="filters" class="portfolio-categories no-left-padding">
					<li><a data-filter="*" class="active" href="#">All works</a></li>
					<li><a data-filter=".design" href="#">Home cleaning</a></li>
					<li><a data-filter=".video" href="#"> Building cleaning</a></li>
					<li><a data-filter=".photography" href="#">Commercial cleaning</a></li>
					<li><a data-filter=".web" href="#">Office cleaning</a></li>
				</ul>
				<ul class="portfolio-list no-left-padding">
					<li class="col-md-4 col-sm-4 col-xs-6 design">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								...
								<a href="gallery-single.html" title="Link"><i class="fa fa-expand"></i></a>
							</div>
						</div>
					</li>
					...
					<li class="col-md-4 col-sm-4 col-xs-6 photography">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								<h5>Quality Cleaning</h5>
								<a class="zoom" href="images/gallery-7.jpg" title="Expand"><i class="fa fa-search"></i></a>
								<a href="gallery-single.html" title="Link"><i class="fa fa-expand"></i></a>
							</div>
						</div>
					</li>
					<li class="col-md-4 col-sm-4 col-xs-6 web">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								<h5>Quality Cleaning</h5>
								<a class="zoom" href="images/gallery-8.jpg" title="Expand"><i class="fa fa-search"></i></a>
								<a href="gallery-single.html" title="Link"><i class="fa fa-expand"></i></a>
							</div>
						</div>
					</li>
					...
					<li class="col-md-4 col-sm-4 col-xs-6 design">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								<h5>Quality Cleaning</h5>
								<a class="zoom" href="images/gallery-9.jpg" title="Expand"><i class="fa fa-search"></i></a>
								<a href="gallery-single.html" title="Link"><i class="fa fa-expand"></i></a>
							</div>
						</div>
					</li>
					<li class="col-md-4 col-sm-4 col-xs-6 video">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								<h5>Quality Cleaning</h5>
								<a class="zoom" href="images/gallery-10.jpg" title="Expand"><i class="fa fa-search"></i></a>
								<a href="gallery-single.html" title="Link"><i class="fa fa-expand"></i></a>
							</div>
						</div>
					</li>
					<li class="col-md-4 col-sm-4 col-xs-6 photography">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								<h5>Quality Cleaning</h5>
								<a class="zoom" href="images/gallery-11.jpg" title="Expand"><i class="fa fa-search"></i></a>
								<a href="gallery-single.html" title="Link"><i class="fa fa-expand"></i></a>
							</div>
						</div>
					</li>
					<li class="col-md-4 col-sm-4 col-xs-6 web">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								<h5>Quality Cleaning</h5>
								<a class="zoom" href="images/gallery-12.jpg" title="Expand"><i class="fa fa-search"></i></a>
								<a href="gallery-single.html" title="Link"><i class="fa fa-expand"></i></a>
							</div>
						</div>
					</li>
